 ...
 * 
 */
@WebServiceClient(name = "TestServiceImplService", targetNamespace = "http://test.zht.com/", wsdlLocation = "http://192.168.1.111:1234/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICEIMPLSERVICE_QNAME = new QName("http://test.zht.com/", "TestServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.111:1234/ws?wsdl");
    ...
    public TestServiceImpl getTestServiceImplPort() {
        return super.getPort(new QName("http://test.zht.com/", "TestServiceImplPort"), TestServiceImpl.class);
    }
    ...
    public TestServiceImpl getTestServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.zht.com/", "TestServiceImplPort"), TestServiceImpl.class, features);
    }
