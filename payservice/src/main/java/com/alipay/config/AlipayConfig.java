...
//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	//notify_url通知接口，是三个真实服务：订单、支付服务、支付宝之间互相通知所调用的接口
	// 服务器异步通知页面路径  需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
	public static String notify_url = "http://121.42.157.19:8080/payservice/pay_notify"; //公网地址

	//return_url页面翻转接口
	// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
	public static String return_url = "http://localhost:18080/tmall_sale/pay_success.do"; //支付宝重定向
