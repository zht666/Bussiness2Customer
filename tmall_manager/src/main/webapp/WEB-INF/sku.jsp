...
<body>
	...
	<div style="margin-top:10px; margin-left:10px">
		一级：<select data-options="width:80" class="easyui-combobox" id="sku_class_1_select" onchange="get_class_2(this.value);"><option>请选择</option></select>&nbsp&nbsp 
		二级：<select data-options="width:80" class="easyui-combobox" id="sku_class_2_select"><option>请选择</option></select><br>
		查询<br>
