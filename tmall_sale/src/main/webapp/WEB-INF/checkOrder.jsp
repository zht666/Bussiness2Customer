	...
	<div class="message">
		...
		<form action="save_order.do" id="order_form">
			<c:forEach items="${list_address}" var="addr">
				<div class="msg_addr">
					<input onclick="show_address('${addr.yh_dz} ${addr.shjr}（收）： ${addr.lxfsh}')" type="radio" name="id" value="${addr.id}"/>
					<span style="width: 100px;" class="msg_left"> 
						${addr.shjr} 
					</span> 
